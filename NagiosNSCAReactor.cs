...
namespace Seq.App.NagiosNCSA
{
    ...
    public class NagiosNCSAReactor : Reactor, ISubscribeTo<LogEventData>
    {
        ...
        protected override void OnAttached()
        {
            ...
            _resetTimer = new Timer(AutoRecoveryTime * 1000);
            _resetTimer.Elapsed += AutoRecoveryTimeElapsed;
